...
#
# Usage:
#   Git/server/test/browser/run.sh                    # default (1 kHz, amp=0.3)
#   Git/server/test/browser/run.sh --amp 0.05         # small amplitude
#   Git/server/test/browser/run.sh --rate 44100       # only 44.1 kHz context
#   Git/server/test/browser/run.sh --headed           # visible browser
