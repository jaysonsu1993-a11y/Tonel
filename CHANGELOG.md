...
> **Note (2026-05-01):** The repo was flattened — `Git/` prefix removed.
> Paths in entries below dated before this change still reference `Git/X`;
> read those as `X` (e.g. `Git/server/src/...` → `server/src/...`).
