# Changelog Archive — pre-v4.0.0 (versions <v4.0.0)

Active changelog: [CHANGELOG.md](CHANGELOG.md). This archive covers v3.x and v1.x.x — kept for traceability but no longer linked from any active doc.

> Pre-2026-05-01 entries here reference the old `Git/` subdirectory layout. Read those paths as if the `Git/` prefix were stripped (e.g. `Git/server/src/...` → `server/src/...`).
